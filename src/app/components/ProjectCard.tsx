...
const ProjectCard: React.FC<Project> = ({
  ...
  <div
    className={`group relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 hover:border-indigo-400/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/10 ${
  ...
  >
    ...
    <div className="p-5 sm:p-6 relative z-10">
      ...
      <p className="text-sm sm:text-base text-gray-300 mb-4 leading-relaxed line-clamp-3">
        {description}
      </p>
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        {technologies.map((tech) => (
          <span
            key={tech}
            className="px-2.5 py-1 bg-gray-700/50 text-gray-300 rounded-full text-xs font-medium border border-gray-600/50 hover:bg-indigo-500/20 hover:border-indigo-400/50 hover:text-indigo-200 transition-all duration-300 cursor-default"
          >
            {tech}
          </span>
        ))}
      ...
      <div className="flex space-x-3">
        <a
          ...
          className="flex items-center space-x-2 text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 px-4 py-2.5 rounded-lg transition-all duration-300 shadow-lg hover:shadow-indigo-500/25 flex-1 justify-center group/btn text-sm font-medium"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center space-x-2 text-gray-400 hover:text-white border border-gray-600 hover:border-gray-400 px-4 py-2.5 rounded-lg transition-all duration-300 hover:bg-gray-700/50 flex-1 justify-center group/btn text-sm font-medium"
        >
